...
<div class="relative inline-block">
    ...
    <div id="{{ $id }}"
        ...
        <ul class="py-2 text-sm text-gray-700" aria-labelledby="btn-{{ $id }}">
            ...
            <li>
                <a href="#" data-value="all" data-label="All" class="block px-4 py-2 hover:bg-gray-100">All</a>
            </li>

            <li>
                <a href="#" data-value="mix" data-label="QS2/QS3/QS4 (MIX)"
                    class="block px-4 py-2 hover:bg-gray-100">QS2/QS3/QS4 (MIX)</a>
            </li>

            <li>
                <a href="#" data-value="qs1" data-label="QS (ALL QS1 Settings)"
                    class="block px-4 py-2 hover:bg-gray-100">QS (ALL QS1 Settings)</a>
            </li>

            <li>
                <a href="#" data-value="none" data-label="No Qualification Settings"
                    class="block px-4 py-2 hover:bg-gray-100">No Qualification Settings</a>
            </li>
