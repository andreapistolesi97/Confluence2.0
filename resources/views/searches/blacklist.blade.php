<x-layout>
    <div class="p-8 mt-15 space-y-10">
        <div class="bg-white rounded-lg border border-color-gray-200 p-6">
            ...
            <span class="block">Here you can upload blacklisted contact from a File csv choosing a business driver</span>  
        </div>
...
<div class="mt-4">
                        <button class="text-white text-sm font-medium rounded-xl bg-green-600 px-5 py-2.5
                               transition hover:bg-green-700 border border-color-gray-700">Import Blacklist</button>
                               </div>
            </div>
        </div>
    </div>
