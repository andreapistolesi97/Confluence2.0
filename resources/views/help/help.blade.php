                ...
                <form>
                    <div class="grid gap-5">
                        ...
                        <textarea rows="4"
                                  placeholder="Details"
                                  class="text-sm border border-gray-300 py-2 px-3 w-full rounded-lg placeholder:text-sm
                                         focus:outline-indigo-600 focus:ring-indigo-600 focus:border-indigo-600"></textarea>
                    </div>

                    <!-- SUBMIT BUTTON -->
                    <div class="mt-6">
                        <button type="submit"
                                class="w-full text-white text-sm rounded-xl bg-green-600 p-2.5
            ...
            <div class="divide-y divide-gray-200">
                ...
                <div class="flex gap-6 py-6">
                    <svg class="w-6 h-6 mt-1.5 text-gray-800"
                         ...
                         viewBox="0 0 24 24"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"/><path stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M9.09 9a3 3 0 1 1 5.83 1c0 2-3 3-3 3"/><path stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" d="M12 17h.01"/></svg>
                ...
                <div class="flex gap-6 py-6">
                    <svg class="w-6 h-6 mt-1.5 text-gray-800"
                         xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                         viewBox="0 0 24 24"><path d="M21.2 8.4c.5.38.8.97.8 1.6v10a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V10a2 2 0 0 1 .8-1.6l8-6a2 2 0 0 1 2.4 0l8 6Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="m22 10-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 10" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
