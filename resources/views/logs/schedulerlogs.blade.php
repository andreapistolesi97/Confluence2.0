<x-layout>
    <div class="p-8 space-y-12 mt-15">
        ...
        <form method="POST" action="{{ route('schedulerlogs.run') }}"
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:gap-4">
                <span class=" w-60 text-sm text-gray-700 mb-2 font-medium">Choose a Scheduler </span>

                <x-dropdownmenulogs id="dropdown-scheduler" :sources="$sources" :current="$current" />
            </div>
            ...
            <div
                ...
                <table class="min-w-full text-sm text-left text-gray-700">
                    <thead class="bg-white text-sm font-semibold whitespace-nowrap border-b border-gray-200">
                        <tr>
                            <th class="px-4 py-3 cursor-pointer">ID_Scheduler-Log</th>
